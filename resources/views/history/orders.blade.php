    ...
    (pr.items || []).forEach((it, idx) => {
        ...
        itemHtml += `
            <tr style="border-bottom:1px solid #e5e7eb">
                ...
                <td style="padding:10px 14px;font-size:11.5px;color:#374151;font-weight:600;max-width:120px;overflow:hidden;text-overflow:ellipsis">${it.specification||'-'}</td>
                <td style="padding:10px 14px;font-size:11.5px;color:#6b7280;max-width:120px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${it.notes && it.notes !== '-' ? it.notes : '-'}</td>
