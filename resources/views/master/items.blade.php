        ...
        <table style="width:100%;border-collapse:collapse;font-size:12.5px">
            <thead>
                <tr style="background:#f9fafb">
                    ...
                    <th style="padding:9px 14px;text-align:left;font-size:10.5px;font-weight:600;color:#6b7280;text-transform:uppercase;letter-spacing:.06em;">SPECIFICATION</th>
            ...
            <tbody id="item-tbody">
                ...
                <tr style="border-bottom:1px solid #f3f4f6;opacity:{{ $item->is_archived ? '0.55' : '1' }}"
                    ...
                    <td style="padding:13px 14px;color:#6b7280;max-width:250px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" title="{{ $item->specification }}">{{ $item->specification ?: '-' }}</td>
